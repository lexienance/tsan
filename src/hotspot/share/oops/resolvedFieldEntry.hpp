...
public:
  ...
  bool is_tsan_ignore()         const { return (_flags & (1 << is_tsan_ignore_shift)) != 0; }
  ...
  void set_flags(bool is_final, bool is_volatile, bool is_tsan_ignore) {
    u1 new_flags = (static_cast<u1>(is_final) << static_cast<u1>(is_final_shift)) |
                   static_cast<u1>(is_volatile) |
                   (static_cast<u1>(is_tsan_ignore) << static_cast<u1>(is_tsan_ignore_shift));
    _flags = new_flags;
  }
